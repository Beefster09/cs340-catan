...
public class JordanAI extends AIPlayer{
	...
	JordanActionManager actionManager;
	
	public JordanAI(ModelFacade game, Player player) {
		super(game, player);
		random = new Random();
		actionManager = new JordanActionManager(game, player);
	}
	...
	public void takeTurn(){
		...
		List<String> bestActions = actionManager.getBestActions();
...
//			server.offerTrade(player.getUUID(), game.getUUID(), offer.getOffer(), recipient.getUUID());
	...
	private void monument(int monuments) {
