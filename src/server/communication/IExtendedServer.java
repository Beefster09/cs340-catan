...
public interface IExtendedServer {
	 ...
	 * @author-Grant
	 */
	public Gson getModel(int gameID, int version)
			throws ServerException, UserException;
	/**
	 * @pre
	 * @post game is reset
	 * @author-Grant
	 */
	public Gson resetGame(int gameID)
			throws ServerException, UserException;
	/**
	 * @pre
	 ...
	 * @author-Grant
	 */
	public Gson executeCommands(int gameID, List<Command> commands)
			throws ServerException, UserException;
	/**
	 ...
	 * @author-Grant
	 */
	public Gson sendChat(PlayerReference user, int gameID, String message)
			throws ServerException, UserException;
	/**
	 * @pre
	 * @post dice is rolled
	 * @author-Grant
	 */
	public Gson rollDice(PlayerReference user, int gameID, int number)
			throws ServerException, UserException;
	/**
	 ...
	 * @author-Grant
	 */
	public Gson robPlayer(PlayerReference user, int gameID,
	 ...
	 * @author-Grant
	 */
	public Gson buyDevCard(PlayerReference user, int gameID)
			throws ServerException, UserException;
	/**
	 ...
	 * @author-Grant
	 */
	public Gson soldier(PlayerReference user, int gameID,
			HexLocation newRobberLocation, PlayerReference victim)
					throws ServerException, UserException;
	/**
	 ...
	 * @author-Grant
	 */
	public Gson monopoly(PlayerReference user, int gameID, ResourceType type)
			throws ServerException, UserException;
	
	/**
	 * 
	 */
	public Gson monument(PlayerReference user, int gameID)
			throws ServerException, UserException;
	 ...
	 * @author-Grant
	 */
	public Gson offerTrade(PlayerReference user, int gameID, ResourceTradeList offer,
	 ...
	 * @author-Grant
	 */
	public Gson respondToTrade(PlayerReference user, int gameID, boolean accept)
			throws ServerException, UserException;
	/**
	 ...
	 * @author-Grant
	 */
	public Gson maritimeTrade(PlayerReference user, int gameID, 
	 ...
	 * @author-Grant
	 */
	public Gson finishTurn(PlayerReference user, int gameID)
			throws ServerException, UserException;
	/**
	 * @pre
	 * @post
